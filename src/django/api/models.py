...
class Have(models.Model):
    have_id = models.IntegerField(primary_key=True)
    user_id = models.CharField(max_length=50)
    ...
    class Meta:
        managed = False
        db_table = 'have'
        unique_together = (('have_id', 'user_id', 'game_id'),)
...
class Level(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'level'
        unique_together = (('level_id', 'user_id', 'game_id'),)
...
class Like(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'like'
        unique_together = (('like_id', 'user_id', 'game_id'),)


class Player(models.Model):
    guest_id = models.IntegerField(primary_key=True)
    recruitment_id = models.IntegerField()
    user_id = models.CharField(max_length=50)
    ...
    class Meta:
        managed = False
        db_table = 'player'
        unique_together = (('guest_id', 'recruitment_id', 'user_id'),)


class Recruitment(models.Model):
    recruitment_id = models.IntegerField(primary_key=True)
    user_id = models.CharField(max_length=50)
    title = models.CharField(max_length=255)
    content = models.TextField(blank=True, null=True)
    max_participant = models.IntegerField()
    now_participant = models.IntegerField()
    ...
    class Meta:
        ...
        unique_together = (('recruitment_id', 'user_id'),)
...
class Review(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'review'
        unique_together = (('review_id', 'user', 'game_id'),)
